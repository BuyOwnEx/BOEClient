<template>
    ...
    <div class="d-flex flex-grow-0 flex-column">
        ...
        <transition mode="out-in" name="slide-left">
          <div class="fill-height" v-if="!additionalParamsEnabled && !useMargin">
            ...
            <div class="blf__volume">
              ...
              <div class="blf__text-field-hint mb-1">
      ...
      <div class="blf__offer-params">
        <div class="blf__text-field-hint" v-if="isSetOffer">
...
.blf {
  ...
  &__cond-params {
    margin-top: 4px;
    .blf__text-field-hint:not(:first-child) {
      margin-top: 2px;
    }
  }
