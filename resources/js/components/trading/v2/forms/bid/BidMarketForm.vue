<template>
        ...
        <transition mode="out-in" name="slide-left">
          <div class="fill-height" v-if="!additionalParamsEnabled && !useMargin">
            ...
            <div class="bmf__volume">
              <div class="bmf__text-field-hint mb-1">
          ...
          <div class="fill-height" v-else-if="additionalParamsEnabled && !useMargin">
            <div v-if="!useMargin && conditionalOrdersAvailable && additionalParamsEnabled" class="bmf__params">
    ...
    <div class="bmf__footer mt-2">
      ...
      <div class="bmf__footer__available text-center mt-1">
        ...
        <span class="bmf__footer__balance">
...
export default {
  ...
  directives: { maska: vMaska },
    ...
    fee_scale() {
      return this.amountScale + Math.abs(this.fee_currency.e);
    },
    ...
    setAmount() {
      if(this.form.base === 0)
      {
        if(BigNumber(this.best_ask).gt(0))
        {
...
.bmf {
  ...
  &__cond-params {
    margin-top: 4px;
    .bmf__text-field-hint:not(:first-child) {
      margin-top: 2px;
    }
  }
