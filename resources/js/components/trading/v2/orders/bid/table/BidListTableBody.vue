		...
		>
			...
			<td>
				<div class="bid-list-table-body__tooltip-volume-wrapper">
					...
					<div class="bid-list-table-body__item--volume text-end">
...
export default {
    ...
    clearItemHover() {
      ...
      document.querySelectorAll('.bid-list-table-body__row').forEach(el => {
      ...
      this.sortedOrdersData.forEach((_, index) => {
        const element = document.querySelectorAll('.bid-list-table-body__row')[index];
