...
<script>
import HistoryDealListTableBody from '@/components/trading/v2/history/table/HistoryDealListTableBody.vue';
import HistoryDealListTableHeader from '@/components/trading/v2/history/table/HistoryDealListTableHeader.vue';
