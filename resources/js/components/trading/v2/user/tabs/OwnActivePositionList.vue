<template>
	<v-card class="own-active-position-list own-list fill-height d-flex flex-column" elevation="0">
		...
		<v-card-text class="own-active-position-list__content pa-0 pt-1 flex-column flex-grow-1">
			<v-data-table
...
export default {
	...
	components: {
		TradingUserDialogPositionAdd: () => import('@/components/trading/v2/user/dialog/TradingUserDialogPositionAdd.vue'),
		TradingUserDialogPositionClose: () => import('@/components/trading/v2/user/dialog/TradingUserDialogPositionClose.vue'),
