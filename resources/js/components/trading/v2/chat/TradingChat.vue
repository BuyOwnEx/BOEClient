...
<script>
import TradingChatContent from '@/components/trading/v2/chat/TradingChatContent.vue';
import TradingChatAddMessage from '@/components/trading/v2/chat/TradingChatAddMessage.vue';
