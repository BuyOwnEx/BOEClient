...
import TradingFormBuyWrapper from '@/components/trading/v1/forms/form/TradingFormBuyWrapper.vue';
import TradingFormSellWrapper from '@/components/trading/v1/forms/form/TradingFormSellWrapper.vue';
import TradingFormsBest from '@/components/trading/v1/forms/common/TradingFormsBest.vue';
export default {
	name: 'TradingForms',
