		...
		<div>
			...
			<div v-if="!useMargin && conditionalOrdersAvailable" class="amf__params">
				<CommonTooltip>
					...
					<template #text>
						{{ $t('trading.forms.ask_stop_loss_info') }}
					</template>
				</CommonTooltip>
				...
				<CommonTooltip>
					...
					<template #text>
						{{ $t('trading.forms.ask_take_profit_info') }}
					</template>
				</CommonTooltip>
				...
				<CommonTooltip>
					...
					<template #text>
						{{ $t('trading.forms.ask_trailing_stop_info') }}
					</template>
				</CommonTooltip>
			</div>
		</div>
...
import TradingFormsConfirmDialog from '@/components/trading/v1/forms/common/TradingFormsConfirmDialog.vue';
