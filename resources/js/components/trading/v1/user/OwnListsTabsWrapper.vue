...
<script>
import OwnActiveOrderList from '@/components/trading/v1/user/tabs/OwnActiveOrderList.vue';
import OwnHistoryDealList from '@/components/trading/v1/user/tabs/OwnHistoryDealList.vue';
import OwnActivePositionList from '@/components/trading/v1/user/tabs/OwnActivePositionList.vue';
