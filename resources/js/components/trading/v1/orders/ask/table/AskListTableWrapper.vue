...
<script>
import AskListTableBody from '@/components/trading/v1/orders/ask/table/AskListTableBody.vue';
import AskListTableHeader from '@/components/trading/v1/orders/ask/table/AskListTableHeader.vue';
