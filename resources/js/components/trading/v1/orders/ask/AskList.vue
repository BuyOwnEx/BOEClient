...
<script>
import AskListTableWrapper from '@/components/trading/v1/orders/ask/table/AskListTableWrapper.vue';
...
export default {
	...
	components: {
		AskListTableWrapper,
		OrdersTooltip: () => import('@/components/trading/v1/orders/common/OrdersTooltip.vue'),
	},
