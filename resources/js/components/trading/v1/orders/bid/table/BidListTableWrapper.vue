...
<script>
import BidListTableBody from '@/components/trading/v1/orders/bid/table/BidListTableBody.vue';
import BidListTableHeader from '@/components/trading/v1/orders/bid/table/BidListTableHeader.vue';
