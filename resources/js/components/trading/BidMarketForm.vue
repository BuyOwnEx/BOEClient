<template>
    <form id="bid_market_form" @submit.prevent="sendBidMarket">
        ...
        <v-text-field
                ...
                :hint="$vuetify.lang.translator('trading.order.pay_market_buy',[fee_visible]) + ' ' +currency.toUpperCase()"
                persistent-hint
                type="text"
                @keydown="validateNumber($event)"
        >
