...
export default {
  ...
  methods: {
    ...mapActions({
      formDeleteSwiftPropsRequestStore: 'user/formDeleteSwiftPropsRequest',
      formDeleteSwiftPropsConfirmStore: 'user/formDeleteSwiftPropsConfirm',
    }),
    async sendConfirmation() {
      try {
        this.startLoading();
        await this.formDeleteSwiftPropsRequestStore(this.form);
        this.step++;
      } finally {
        this.stopLoading();
      }
    ...
    handleCodeInput(value) {
      if (value.length === 6 && this.emailCode) this.confirmDeleteSwiftProps();
    },
    async confirmDeleteSwiftProps() {
      ...
      try {
        ...
        const success = await this.formDeleteSwiftPropsConfirmStore(payload);
        if (success) {
