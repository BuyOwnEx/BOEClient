                    ...
                    <v-container>
                        <v-row>
                            <v-col cols="12" md="12">
                                ...
                                <span class="available_balance" @click="setAmount()">{{this.safe_balance.toString()}}</span> {{cryptoObj.currency.toUpperCase()}}
                                <v-text-field
                                        v-model="form.amount"
                                        label="Amount*"
    ...
    export default {
        ...
        data () {
            return {
                ...
                menuTitle: this.$vuetify.lang.translator('balance.transfer_to_trade'),
