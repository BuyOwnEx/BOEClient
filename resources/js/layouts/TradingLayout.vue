<template>
  <div class="d-flex flex-grow-1">
      ...
      >
        <div class="d-flex flex-grow-1 align-center">
          <div class="d-flex flex-grow-1 align-center">
            ...
            <div v-if="!isLogged" class="d-flex" style="padding: 0 4px;">
              <v-list-item-avatar height="48" min-width="48" width="48" >
                <Link path="/" class="logo_link"><v-img contain :src="Logo" /></Link>
              </v-list-item-avatar>
    ...
    <v-main class="main" style="height: calc(100vh)">
...
import TradingChartMarketInfo from "@/components/trading/v2/chart/TradingChartMarketInfo.vue";
