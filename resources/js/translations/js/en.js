...
make our system processes as transparent as possible.`,
	...
	support: {
		...
		files_hint: 'Allowed file formats are: .jpg, .png, .pdf, .doc, .docx and .zip archive. Maximum total size of uploaded files: 15 Mb',
	...
	kyc: {
		...
		manual: {
			legal: {
                ...
                max_files_size_error: 'The total file size limit has been exceeded. The total size of all uploaded documents must be less than {size}Mb',
				title: 'Company info',
                documents: 'Documents',
                ...
                docs_description: 'The total size of the files should not exceed {size}Mb, and their number should not exceed {limit}',
		...
		zip_file_doc_hint: 'Attach the archive with the documents. Available formats: .zip. Max. file size is 100Mb',
        multiple_doc_hint: 'Attach a document in .jpg, .png, .pdf, .doc, .docx format or a .zip archive. Maximum file size is 15Mb',
	...
	forms_validation: {
        ...
        max_multi_filesize_15MB: 'The total file size should not exceed 15Mb',
		fill_all_fields: 'Fill all fields',
