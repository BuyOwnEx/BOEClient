	...
	balance: {
		...
		dialog: {
			...
			fiat_replenishment_alert:
				...
				'Нажимая кнопку Пополнить, вы соглашаетесь с этими условиями ',
			fiat_bank_details_replenishment_description:
				'Укажите сумму на которую вы хотите пополнить счет. После этого вы будете перенаправлены на форму сканирования qr-кода.\n' +
				'После выполняения платежа, обязательно нажмите кнопку "Я оплатил(а)". ',
