export default {
	...
	table_header: {
		...
		filled: 'Завершено %',
		trading: 'Торговля',
		margin_trading: 'Долевая торговля',
		platform: 'Платформа',
		network: 'Сеть',
	...
	trading: {
		...
		headers: {
			history_deal_list: 'История операций',
		...
		order: {
			...
			pay_limit_buy: 'Вы получите (комиссия {0} %)',
			pay_market_buy: 'Вы получите (комиссия {0} %)',
			pay_limit_sell: 'Вы получите (комиссия {0} %)',
			pay_market_sell: 'Вы получите примерно (комиссия {0} %)',
	...
	auth: {
		...
		login: {
			...
			verified_text: 'E-Mail успешно подтвержден',
			captcha_error: 'Ошибка валидации Captcha',
		},
		register: {
			title: 'Регистрация',
			subtitle: 'Заполните поля ниже, чтобы зарегистрироваться в качестве пользователя',
			name: 'Полное имя',
			button: 'Регистрация',
			orsign: 'Или зарегистрируйтесь с',
			agree: 'Регистрируясь, вы соглашаетесь с',
			terms_link: 'Правилами пользования',
			policy_link: 'Даете согласие на обработку персональных данных',
	...
	balance: {
		...
		dialog: {
			...
			fiat_replenishment_alert:
				'Принимаются и обрабатываются только платежи, выполненные через форму пополнения.\n' +
	...
	docs: {
		...
		terms: {
			...
			account: {
				title: 'Согласие о взаимодействии',
				content:
					'<p>' +
					'  ТЕКСТ' +
					'</p>',
	...
	status: {
		...
		description: `Состояние системы - это инструмент мониторинга, который предоставляет
			информацию о доступности ввода, вывода и операциям в режиме реального
		...
		fiat_status: 'Состояние системы по валютам',
		currency_status: 'Состояние системы по цифровым валютам',
		pairs_status: 'Состояние системы по парам',

		support_currencies_only_crypto: 'Поддерживаются <b>{0}</b> цифровых валют (монет/токенов)',
		support_currencies_fiat_and_crypto:
			'Поддерживаются <b>{0}</b> валют: <b>{1}</b> цифровых валют (монет/токенов) и <b>{2}</b> фиатных валют',
	...
	fees: {
		...
		trading_fee: 'Операционная комиссия',
	...
	user: {
			...
			dialog: {
				create: {
					...
					copy_tokens_description:
						'Скопируйте данные API ключи, поскольку при закрытии диалогового окна API Key будет отображен как SHA 256 хэш, а Secret Key будет скрыт',
					api_key: 'API ключ',
		...
		security: {
			...
			description: {
				...
				line_two:
					'Наша ИС использует 2FA от утилиты Google Authenticator. Для включения такой возможности, скачайте Google Authenticator на свой мобильный телефон и просканируйте QR-код.',
				line_three: 'После установки приложения, используйте указанные в нём коды для работы с ИС.',
			},
	...
	reports: {
		...
		crypto_transactions_title: 'ЦВ транзакции',
