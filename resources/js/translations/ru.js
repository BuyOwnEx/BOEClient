	...
	notifications: {
		...
		kinds: {
			login: {
				...
				text: 'Был выполнен вход в систему с IP {0}. Если это были не вы, просьба незамедлительно сообщить в службу поддержки',
			},
			add_money: {
			...
			trading_block: {
				...
				text: 'Ваши торговые операции были заблокированы. Причину блокировки вы можете узнать, обратившись в службу поддержки',
			},
			money_block: {
			...
			position_liquidation_warn: {
				...
				text: 'Уведомляем о вожможной ликвидации вашей позиции. Внесите обеспечительный платеж под позицию как можно скорее для избежания ликвидации',
			},
			...
			maintenance: {
				...
				text: 'Уведомляем о предстоящем техническом обслуживании биржи в период с {0} по {1}. Приносим извинения за доставленные неудобства',
			},
			news: {
