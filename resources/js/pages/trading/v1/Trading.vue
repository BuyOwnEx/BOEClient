...
import TickersList from '@/components/trading/v1/tickers/TradingTickersList.vue';
import TradingChartWrapper from '@/components/trading/v1/chart/TradingChartWrapper.vue';
import HistoryDealList from '@/components/trading/v1/history/HistoryDealList.vue';

import TradingChat from '@/components/trading/v1/chat/TradingChat.vue';
import AskList from '@/components/trading/v1/orders/ask/AskList.vue';
import TradingMarketActivity from '@/components/trading/v1/market/TradingMarketActivity.vue';
import BidList from '@/components/trading/v1/orders/bid/BidList.vue';

import TradingFormsWrapper from '@/components/trading/v1/forms/TradingFormsWrapper.vue';
import OwnListsTabsWrapper from '@/components/trading/v1/user/OwnListsTabsWrapper.vue';
...
export default {
  ...
  components: {
    ...
    AskList,
    AskBidLastPrice: () => import('@/components/trading/v1/orders/mobile/AskBidLastPrice.vue'),
    BidList,
    TradingFormsWrapper,
    OwnListsTabsWrapper,
  },
