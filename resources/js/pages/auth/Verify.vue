<template>
    <div class="layout-content ma-auto">
        <v-card>
            ...
            <div class="caption grey--text darken-4 pl-6 pr-6"><small>{{$vuetify.lang.translator('auth.no_letter')}}</small></div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                formSubTitle: 'Please, activate your account by checking activation link in your email. Activation link is valid for 1 hour',
                applyButton: 'Resend',
                rules: {
