                                        ...
                                        <v-container fluid>
                                            <v-row>
                                                ...
                                                <v-select
                                                        ...
                                                        @change="setEnabled"
                                                        :items="all_ref_types"
                                                        :item-text="item => item.percent +'% during '+ item.days + 'days'"
                                                        item-value="id"
                                                        label="Referral type"
                                                        ...
                                                        clearable
                                                ></v-select>
                                                <v-btn class="ma-2" tile color="primary" :disabled="disabled" @click="setRefType">Apply</v-btn>
                                            </v-row>
                                        </v-container>
                                    </v-form>
                                </v-card-text>
...
<script>
    export default {
        ...
        created() {
            axios.get('/trader/ext/all_referral_types')
                .then(response => {
        ...
        methods: {
            ...
            setRefType() {
                this.disabled = true;
                axios.post('/trader/ext/set_referral_type', {
                    type: this.ref_type
                }).then((response) => {
