	...
	<div class='w-full'>
		...
		<v-card class='pa-3' flat>
				...
				<v-col cols='12' md='4'>
					...
					<div class='d-flex align-center'>
						<v-rating
							...
							readonly
						></v-rating>
						<span class='text-overline ml-1'>({{ product.reviews ? product.reviews.length : 0
							}} {{ $t('ecommerce.customerReviews') }})</span>
					</div>
					<v-divider class='my-2'></v-divider>
					<div class='d-flex align-center text-h6'>
						<div>{{ $t('ecommerce.price') }}:</div>
						<span class='text-decoration-line-through mx-1 font-weight-regular'>{{ product.priceCompare | formatCurrency
							}}</span>
						<span>{{ product.price | formatCurrency }}</span>
					</div>
					<div class='mt-3 text-body-1'>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate totam consectetur consequatur. Repudiandae,
						voluptatem deserunt ex quia placeat est labore.
					</div>
					<v-divider class='my-2'></v-divider>
			...
			<div>
				...
				<div class='text-body-1 my-2'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum perferendis
					exercitationem rem sed fugiat, voluptatibus officia repudiandae itaque unde nesciunt sequi, ex repellendus tempore,
					veniam asperiores dolores facilis debitis similique nam optio cupiditate porro. Blanditiis cum expedita facere
					iusto dolore, praesentium vitae hic? Eaque suscipit fugit iusto, ab voluptatibus officia animi ipsam quae rem iste
					aliquid. Quo molestias possimus nisi accusamus ipsum error corrupti. Consequatur molestias itaque magnam libero
					asperiores similique nam quam in explicabo, aliquam ab laboriosam saepe modi blanditiis dolor esse laudantium at!
					Cumque odit illum possimus adipisci, quis praesentium fugiat id sit repudiandae eum. Eos, soluta ipsum.
				</div>
			</div>
			<v-divider class='my-3'></v-divider>
			<div>
