...
<script>
import NotificationsSidebarMenu from '@/components/notifications/sidebar/NotificationsSidebarMenu.vue';
import NotificationsListWrapper from '@/components/notifications/list/NotificationsListWrapper.vue';
