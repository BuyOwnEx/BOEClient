                ...
                <v-card>
                    <v-data-table
                        ...
                        <template v-slot:item.currency="{ item }">
                            ...
                            <v-img v-else class="elevation-0 d-inline-flex" style="vertical-align: middle" :src="getImage(item.logo)" max-height="32" max-width="32"></v-img>
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                tableCaption: 'Internal transfers',
                totalItems: 0,
                items: [],
                loading: true,
                options: {},
        ...
        mounted () {
            axios.get('/trader/ext/all_currencies')
                .then(response => {
