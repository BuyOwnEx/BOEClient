<template>
	<div>
		...
		>
			<v-row align='center'>
				<v-col class='grow'>Nunc nonummy metus. Nunc interdum lacus sit amet orci. Nullam dictum felis eu pede mollis
					pretium. Cras id dui.
				</v-col>
				<v-col class='shrink'>
		...
		>
			...
			Sed aliquam ultrices mauris. Donec vitae orci sed dolor rutrum auctor.
		</v-alert>
		<v-alert
		...
		>
			...
			Curabitur blandit mollis lacus. Curabitur blandit mollis lacus.
		</v-alert>
	</div>
</template>
